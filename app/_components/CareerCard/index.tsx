...
export const CareerCard = ({ entry }: { entry: CareerEntry }) => (
    <div className="animate-rotate-border w-full rounded-2xl bg-transparent from-zinc-200 from-0% via-green-400 to-zinc-200 to-100% p-px transition-all duration-300 ease-out hover:-translate-y-1.5 hover:bg-conic/[from_var(--border-angle)] hover:shadow-[0_8px_24px_-4px_rgba(0,0,0,0.3),0_2px_8px_-2px_rgba(0,0,0,0.04)]">
