...
export const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 w-full
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            >
              <span className={`block w-[22px] h-[2px] bg-black rounded transition-all duration-300 origin-center
                ${isOpen ? "translate-y-[7px] rotate-45" : ""}`} />
              <span className={`block w-[22px] h-[2px] bg-black rounded transition-all duration-300
      ...
      <div className={`fixed inset-0 z-40 bg-white/97 backdrop-blur-xl
