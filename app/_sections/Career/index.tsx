    ...
    return (
        <section id="carrer" className="w-full bg-zinc-50 py-12 pb-[130px] relative overflow-hidden  scroll-mt-14">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                {/* Header */}
                <div className="mb-12">
                    <p className="text-xs font-medium tracking-widest uppercase text-zinc-400 mb-2">Trajetória</p>
                ...
                <div className="relative max-w-4xl mx-auto hidden md:block">
                    ...
                    {CAREER.map((entry, i) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className={`w-[calc(50%-28px)] flex-shrink-0 py-4 flex ${isLeft ? "justify-end" : "justify-start"}`}
                                >
                                    <CareerCard entry={entry} />
                                </div>
