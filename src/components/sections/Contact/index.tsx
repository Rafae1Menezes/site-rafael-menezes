...
export const ContactSection = async () => {
    ...
    return (
        <section
            ...
            className="w-full scroll-mt-10 bg-[#FEFEFE] pb-12 sm:scroll-mt-14"
        >
                ...
                <div className="relative overflow-hidden rounded-3xl border border-zinc-200 bg-zinc-50 p-8 sm:p-12">
                    ...
                    <div className="relative flex flex-col items-center gap-8 sm:flex-row sm:items-start">
                        <div className="flex-1 text-center sm:text-left">
                            <Header title={t("title")} subtitle={t("subtitle")} headingId="contact-heading" />
                            <p className="mb-8 max-w-md text-sm leading-relaxed text-zinc-600">{t("description")}</p>

                            <ul aria-label={t("contactLinksLabel")} className="flex flex-col flex-wrap gap-3 sm:flex-row">
                                {links.map((link) => (
                                    <li key={link.label}>
                                        <Button
                                            as="link"
